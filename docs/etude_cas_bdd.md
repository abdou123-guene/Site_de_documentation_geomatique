...
### b) Périmètre de travail {#périmètre-de-travail}
...
### c) Analyse des besoins {#analyse-des-besoins}
...
### a) Données GTFS (General Transit Feed Specification) {#données-gtfs-(general-transit-feed-specification)}
...
### b) Standard CNIG “Accessibilité”[^4] {#standard-cnig-“accessibilité”}
...
### c) Analyse critique des modèles comparatives (MCD Travaux) {#analyse-critique-des-modèles-comparatives-(mcd-travaux)}
...
### a) Description des exigences générales  {#description-des-exigences-générales}
...
### b) Modèles conceptuels de données  {#modèles-conceptuels-de-données}
...
### a) Choix d’implémentation {#choix-d’implémentation}
...
### b) Livraison informatique {#livraison-informatique}
...
### c) Implémentation physique {#implémentation-physique}
...
### d) Représentation graphique {#représentation-graphique}
...
### a) Administration de la base de données {#administration-de-la-base-de-données}
...
### b)  Sauvegardes et versionnement {#sauvegardes-et-versionnement}
